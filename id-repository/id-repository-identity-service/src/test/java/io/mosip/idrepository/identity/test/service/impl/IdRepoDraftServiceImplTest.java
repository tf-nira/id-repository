...
public class IdRepoDraftServiceImplTest {
	...
	public void setup() throws IdRepoDataValidationException {
		...
		IdentityMapping.FatherPlaceOfResidenceDistrict fatherPlaceOfResidenceDistrict = new IdentityMapping.FatherPlaceOfResidenceDistrict();
		fatherPlaceOfResidenceDistrict.setValue("fatherPlaceOfResidenceDistrict");
		identityMapping.getIdentity().setFatherPlaceOfResidenceDistrict(fatherPlaceOfResidenceDistrict);
		IdentityMapping.FatherPlaceOfResidenceCounty fatherPlaceOfResidenceCounty = new IdentityMapping.FatherPlaceOfResidenceCounty();
		fatherPlaceOfResidenceCounty.setValue("fatherPlaceOfResidenceCounty");
		identityMapping.getIdentity().setFatherPlaceOfResidenceCounty(fatherPlaceOfResidenceCounty);
		IdentityMapping.FatherPlaceOfResidenceSubCounty fatherPlaceOfResidenceSubCounty = new IdentityMapping.FatherPlaceOfResidenceSubCounty();
		fatherPlaceOfResidenceSubCounty.setValue("fatherPlaceOfResidenceSubCounty");
		identityMapping.getIdentity().setFatherPlaceOfResidenceSubCounty(fatherPlaceOfResidenceSubCounty);
		IdentityMapping.FatherPlaceOfResidenceParish fatherPlaceOfResidenceParish = new IdentityMapping.FatherPlaceOfResidenceParish();
		fatherPlaceOfResidenceParish.setValue("fatherPlaceOfResidenceParish");
		identityMapping.getIdentity().setFatherPlaceOfResidenceParish(fatherPlaceOfResidenceParish);
		IdentityMapping.FatherPlaceOfResidenceVillage fatherPlaceOfResidenceVillage = new IdentityMapping.FatherPlaceOfResidenceVillage();
		fatherPlaceOfResidenceVillage.setValue("fatherPlaceOfResidenceVillage");
		identityMapping.getIdentity().setFatherPlaceOfResidenceVillage(fatherPlaceOfResidenceVillage);
		IdentityMapping.FatherPlaceOfResidenceStreet fatherPlaceOfResidenceStreet = new IdentityMapping.FatherPlaceOfResidenceStreet();
		fatherPlaceOfResidenceStreet.setValue("fatherPlaceOfResidenceStreet");
		identityMapping.getIdentity().setFatherPlaceOfResidenceStreet(fatherPlaceOfResidenceStreet);
		IdentityMapping.FatherPlaceOfResidenceHouseNo fatherPlaceOfResidenceHouseNo = new IdentityMapping.FatherPlaceOfResidenceHouseNo();
		fatherPlaceOfResidenceHouseNo.setValue("fatherPlaceOfResidenceHouseNo");
		identityMapping.getIdentity().setFatherPlaceOfResidenceHouseNo(fatherPlaceOfResidenceHouseNo);
		IdentityMapping.FatherPostalAddress fatherPostalAddress = new IdentityMapping.FatherPostalAddress();
		fatherPostalAddress.setValue("fatherPostalAddress");
		identityMapping.getIdentity().setFatherPostalAddress(fatherPostalAddress);
		IdentityMapping.FatherForeignResidenceCountry fatherForeignResidenceCountry = new IdentityMapping.FatherForeignResidenceCountry();
		fatherForeignResidenceCountry.setValue("fatherForeignResidenceCountry");
		identityMapping.getIdentity().setFatherForeignResidenceCountry(fatherForeignResidenceCountry);
		IdentityMapping.FatherForeignResidenceAddress fatherForeignResidenceAddress = new IdentityMapping.FatherForeignResidenceAddress();
		fatherForeignResidenceAddress.setValue("fatherForeignResidenceAddress");
		identityMapping.getIdentity().setFatherForeignResidenceAddress(fatherForeignResidenceAddress);
		IdentityMapping.FatherPlaceOfOriginDistrict fatherPlaceOfOriginDistrict = new IdentityMapping.FatherPlaceOfOriginDistrict();
		fatherPlaceOfOriginDistrict.setValue("fatherPlaceOfOriginDistrict");
		identityMapping.getIdentity().setFatherPlaceOfOriginDistrict(fatherPlaceOfOriginDistrict);
		IdentityMapping.FatherIndigenousCommunityTribe fatherIndigenousCommunityTribe = new IdentityMapping.FatherIndigenousCommunityTribe();
		fatherIndigenousCommunityTribe.setValue("fatherIndigenousCommunityTribe");
		identityMapping.getIdentity().setFatherIndigenousCommunityTribe(fatherIndigenousCommunityTribe);
		IdentityMapping.FatherIndigenousCommunityClan fatherIndigenousCommunityClan = new IdentityMapping.FatherIndigenousCommunityClan();
		fatherIndigenousCommunityClan.setValue("fatherIndigenousCommunityClan");
		identityMapping.getIdentity().setFatherIndigenousCommunityClan(fatherIndigenousCommunityClan);
		IdentityMapping.FatherForeignOriginCountry fatherForeignOriginCountry = new IdentityMapping.FatherForeignOriginCountry();
		fatherForeignOriginCountry.setValue("fatherForeignOriginCountry");
		identityMapping.getIdentity().setFatherForeignOriginCountry(fatherForeignOriginCountry);
		IdentityMapping.FatherForeignOriginAddress fatherForeignOriginAddress = new IdentityMapping.FatherForeignOriginAddress();
		fatherForeignOriginAddress.setValue("fatherForeignOriginAddress");
		identityMapping.getIdentity().setFatherForeignOriginAddress(fatherForeignOriginAddress);
		IdentityMapping.MotherPlaceOfResidenceDistrict motherPlaceOfResidenceDistrict = new IdentityMapping.MotherPlaceOfResidenceDistrict();
		motherPlaceOfResidenceDistrict.setValue("motherPlaceOfResidenceDistrict");
		identityMapping.getIdentity().setMotherPlaceOfResidenceDistrict(motherPlaceOfResidenceDistrict);
		IdentityMapping.MotherPlaceOfResidenceCounty motherPlaceOfResidenceCounty = new IdentityMapping.MotherPlaceOfResidenceCounty();
		motherPlaceOfResidenceCounty.setValue("motherPlaceOfResidenceCounty");
		identityMapping.getIdentity().setMotherPlaceOfResidenceCounty(motherPlaceOfResidenceCounty);
		IdentityMapping.MotherPlaceOfResidenceSubCounty motherPlaceOfResidenceSubCounty = new IdentityMapping.MotherPlaceOfResidenceSubCounty();
		motherPlaceOfResidenceSubCounty.setValue("motherPlaceOfResidenceSubCounty");
		identityMapping.getIdentity().setMotherPlaceOfResidenceSubCounty(motherPlaceOfResidenceSubCounty);
		IdentityMapping.MotherPlaceOfResidenceParish motherPlaceOfResidenceParish = new IdentityMapping.MotherPlaceOfResidenceParish();
		motherPlaceOfResidenceParish.setValue("motherPlaceOfResidenceParish");
		identityMapping.getIdentity().setMotherPlaceOfResidenceParish(motherPlaceOfResidenceParish);
		IdentityMapping.MotherPlaceOfResidenceVillage motherPlaceOfResidenceVillage = new IdentityMapping.MotherPlaceOfResidenceVillage();
		motherPlaceOfResidenceVillage.setValue("motherPlaceOfResidenceVillage");
		identityMapping.getIdentity().setMotherPlaceOfResidenceVillage(motherPlaceOfResidenceVillage);
		IdentityMapping.MotherPlaceOfResidenceStreet motherPlaceOfResidenceStreet = new IdentityMapping.MotherPlaceOfResidenceStreet();
		motherPlaceOfResidenceStreet.setValue("motherPlaceOfResidenceStreet");
		identityMapping.getIdentity().setMotherPlaceOfResidenceStreet(motherPlaceOfResidenceStreet);
		IdentityMapping.MotherPlaceOfResidenceHouseNo motherPlaceOfResidenceHouseNo = new IdentityMapping.MotherPlaceOfResidenceHouseNo();
		motherPlaceOfResidenceHouseNo.setValue("motherPlaceOfResidenceHouseNo");
		identityMapping.getIdentity().setMotherPlaceOfResidenceHouseNo(motherPlaceOfResidenceHouseNo);
		IdentityMapping.MotherPostalAddress motherPostalAddress = new IdentityMapping.MotherPostalAddress();
		motherPostalAddress.setValue("motherPostalAddress");
		identityMapping.getIdentity().setMotherPostalAddress(motherPostalAddress);
		IdentityMapping.MotherForeignResidenceCountry motherForeignResidenceCountry = new IdentityMapping.MotherForeignResidenceCountry();
		motherForeignResidenceCountry.setValue("motherForeignResidenceCountry");
		identityMapping.getIdentity().setMotherForeignResidenceCountry(motherForeignResidenceCountry);
		IdentityMapping.MotherForeignResidenceAddress motherForeignResidenceAddress = new IdentityMapping.MotherForeignResidenceAddress();
		motherForeignResidenceAddress.setValue("motherForeignResidenceAddress");
		identityMapping.getIdentity().setMotherForeignResidenceAddress(motherForeignResidenceAddress);
		IdentityMapping.MotherPlaceOfOriginDistrict motherPlaceOfOriginDistrict = new IdentityMapping.MotherPlaceOfOriginDistrict();
		motherPlaceOfOriginDistrict.setValue("motherPlaceOfOriginDistrict");
		identityMapping.getIdentity().setMotherPlaceOfOriginDistrict(motherPlaceOfOriginDistrict);
		IdentityMapping.MotherIndigenousCommunityTribe motherIndigenousCommunityTribe = new IdentityMapping.MotherIndigenousCommunityTribe();
		motherIndigenousCommunityTribe.setValue("motherIndigenousCommunityTribe");
		identityMapping.getIdentity().setMotherIndigenousCommunityTribe(motherIndigenousCommunityTribe);
		IdentityMapping.MotherIndigenousCommunityClan motherIndigenousCommunityClan = new IdentityMapping.MotherIndigenousCommunityClan();
		motherIndigenousCommunityClan.setValue("motherIndigenousCommunityClan");
		identityMapping.getIdentity().setMotherIndigenousCommunityClan(motherIndigenousCommunityClan);
		IdentityMapping.MotherForeignOriginCountry motherForeignOriginCountry = new IdentityMapping.MotherForeignOriginCountry();
		motherForeignOriginCountry.setValue("motherForeignOriginCountry");
		identityMapping.getIdentity().setMotherForeignOriginCountry(motherForeignOriginCountry);
		IdentityMapping.MotherForeignOriginAddress motherForeignOriginAddress = new IdentityMapping.MotherForeignOriginAddress();
		motherForeignOriginAddress.setValue("motherForeignOriginAddress");
		identityMapping.getIdentity().setMotherForeignOriginAddress(motherForeignOriginAddress);

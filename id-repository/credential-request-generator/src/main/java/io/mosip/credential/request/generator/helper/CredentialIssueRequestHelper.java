...
public class CredentialIssueRequestHelper {
	...
	public CredentialServiceRequestDto getCredentialServiceRequestDto(
			CredentialIssueRequestDto credentialIssueRequestDto, String requestId) throws JsonProcessingException {
	...
	public CredentialIssueRequestDto getCredentialIssueRequestDto(CredentialEntity credentialEntity)
			throws JsonProcessingException {
		String request = credentialEntity.getRequest();
		String decryptedData = new String(CryptoUtil.decodeURLSafeBase64(cryptoUtil.decryptData(request)));
		CredentialIssueRequestDto credentialIssueRequestDto = objectMapper.readValue(decryptedData,
